...
def organizar_arquivos():
    ...
    # A pasta de destino é uma subpasta chamada "Organizados"
    ...
    for arquivo in arquivos:
        ...
        # Verifique se é um arquivo e não é o script atual
        if os.path.isfile(caminho_arquivo) and arquivo != "organizador.py":
